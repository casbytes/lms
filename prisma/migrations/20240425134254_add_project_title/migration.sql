...
INSERT INTO "new_Test" ("attempted", "attempts", "id", "moduleProgressId", "nextAttemptAt", "score", "subModuleProgressId", "userId") SELECT "attempted", "attempts", "id", "moduleProgressId", "nextAttemptAt", "score", "subModuleProgressId", "userId" FROM "Test";
DROP TABLE "Test";
...
INSERT INTO "new_Checkpoint" ("id", "moduleProgressId", "score", "status", "subModuleProgressId", "userId") SELECT "id", "moduleProgressId", "score", "status", "subModuleProgressId", "userId" FROM "Checkpoint";
